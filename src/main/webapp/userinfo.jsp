        ...
        <div class="container mt-5 mb-5">
            <div class="d-flex justify-content-center row">
                <div class="col-md-8">
                    <table>
                            <tr>
                                <td>Username:<input type="text" name="username" value="${users.username}"></td>
                                <td>Password:<input type="password" name="password" value="${users.password}"></td>
                                <td>Name:<input type="password" name="password" value="${users.password}"></td>
                                <td>Role: <select name="role">
                                    <option value="admin">Admin</option>
                                    <option value="guest">Guest</option>
                                </select></td>
                                <td><a href="/user?action=edit&id=${users.id}">Edit</a></td>
                                <td><a href="/user?action=delete&id=${users.id}">Delete</a></td>
                            </tr>
                    </table>
                </div>
            </div>
