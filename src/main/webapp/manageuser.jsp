                    ...
                    <table>
                        <c:forEach var="users" items="${users}">
                            <tr>
                                ...
                                <td>Name:<input type="text" name="name" value="${users.name}"></td>
                                <td>Role: <input type="text"name="role" value="${users.role}"></td>
                                <td><a href="/user?action=manageedit&id=${users.id}">Edit</a></td>
