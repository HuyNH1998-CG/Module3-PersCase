...
<div id="breadcrumb" class="section">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <h3 class="breadcrumb-header">Change user info</h3>
    ...
    <div class="container">
        ...
        <div class="container mt-5 mb-5">
            <div class="d-flex justify-content-center row">
                <div class="col-md-8">
                    <form method="post" action="/user?action=manageedit">
                        <table>
                            <tr>
                                <th>ID</th>
                                <td><input type="text" name="id" value="${users.id}" readonly></td>
                            </tr>
                            <tr>
                                <th>Username</th>
                            ...
                            <tr>
                                <th>Birthday</th>
                                <td><input type="date" name="dob" value="${users.dob}"></td>
                            </tr>
                            <tr>
                                <th>Phone</th>
