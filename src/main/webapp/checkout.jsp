			...
			<div class="col-md-6 order-details">
				...
				<div class="payment-method">
					<div class="input-radio">
						...
						<div class="caption">
							<p>Please send you money to the following bank account sxxx-cxxx-axxx-mxxx</p>
						</div>
					</div>
					<div class="input-radio">
						...
						<div class="caption">
							<p>Pay when the order is delivered to you</p>
						</div>
					</div>
				</div>
				...
				<a href="/checkout?action=insert" class="primary-btn order-submit">Place order</a>
			</div>
			<!-- /Order Details -->
		</div>
		<div class="col-md-3"></div>
